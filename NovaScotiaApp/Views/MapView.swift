...
private let mapPlaces: [MapPlaceItem] = [
    ...
    MapPlaceItem(id: "6", title: "Sunset Cliffs Point", imageName: "SunsetCliffsPoint", category: "Scenic Viewpoints", rating: "4.8", distance: "3.6 km", coordinate: CLLocationCoordinate2D(latitude: 44.6550, longitude: -63.5780), bestTime: "Sunset", price: "Free", duration: "1-2h"),
    MapPlaceItem(id: "7", title: "Seagrass Lagoon", imageName: "SeagrassLagoon", category: "Snorkeling", rating: "4.5", distance: "2.8 km", coordinate: CLLocationCoordinate2D(latitude: 44.6520, longitude: -63.5650), bestTime: "Morning", price: "$", duration: "2-3h"),
    MapPlaceItem(id: "8", title: "Lighthouse Bluff Trail", imageName: "LighthouseBluffTrail", category: "Scenic Trails", rating: "4.7", distance: "4.1 km", coordinate: CLLocationCoordinate2D(latitude: 44.6680, longitude: -63.5880), bestTime: "Morning", price: "Free", duration: "2-3h"),
    MapPlaceItem(id: "9", title: "Tidepool Discovery Beach", imageName: "TidepoolDiscoveryBeach", category: "Beaches", rating: "4.6", distance: "2.3 km", coordinate: CLLocationCoordinate2D(latitude: 44.6440, longitude: -63.5720), bestTime: "Low tide", price: "Free", duration: "2-3h")
]
